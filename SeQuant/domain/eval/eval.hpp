...
///        The MBPT cleanup restroes the effect of deleted terms that was
///        filtered to get the most compact-set of closed-shell equations by
///        applying the transformation: result = identity - (1/ket_rank!) *
